...
extern fun _ward_js_decompress
  (data: ptr, data_len: int, method: int, resolver: ptr)
...
ward_decompress{lb}{n}(data, data_len, method) = let
  ...
  val () = _ward_js_decompress(dp, data_len, method, rp)
in p end
